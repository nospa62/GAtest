...
def create_cigre_hv_network():
    ...
    net_data = {
        ...
        'loads': [
            {'bus': 1, 'p_mw': 285.0, 'q_mvar': 200.0},
            {'bus': 2, 'p_mw': 325.0, 'q_mvar': 244.0},
            {'bus': 3, 'p_mw': 326.0, 'q_mvar': 244.0},
            {'bus': 4, 'p_mw': 103.0, 'q_mvar': 62.0},
            {'bus': 5, 'p_mw': 435.0, 'q_mvar': 296.0}
        ],
        'gens': [
            {'id': 0, 'bus': 9, 'name': 'Gen 9 (Slack)', 'p_mw': 0, 'vm_pu': 1.03},
    ...
    for shunt in net_data['shunts']:
        pp.create_shunt(net, bus=shunt['bus'], p_mw=0, q_mvar=shunt['q_mvar'])
    ...
    net.gen_adv_params = {
        0: {'max_s_mva': 1000, 'ramp_up_mw_min': 80.0, 'ramp_down_mw_min': 80.0},
        1: {'max_s_mva': 600, 'ramp_up_mw_min': 50.0, 'ramp_down_mw_min': 50.0},
        2: {'max_s_mva': 800, 'ramp_up_mw_min': 60.0, 'ramp_down_mw_min': 60.0},
    }
    net.prev_gen_p_mw = {
        0: 400.0,
        1: 300.0,
